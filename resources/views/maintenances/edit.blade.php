                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('maintenances.update', $maintenance) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="tanggal_perawatan" id="tanggal_perawatan" value="{{ old('tanggal_perawatan', $maintenance->tanggal_perawatan->format('Y-m-d')) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="kilometer" id="kilometer" value="{{ old('kilometer', $maintenance->kilometer) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="biaya_total" id="biaya_total" value="{{ old('biaya_total', $maintenance->biaya_total) }}" step="0.01"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="sedang_proses" {{ old('status', $maintenance->status) == 'sedang_proses' ? 'selected' : '' }}>Sedang Proses</option>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="catatan" id="catatan" rows="3"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('catatan', $maintenance->catatan) }}</textarea>
                        </div>
