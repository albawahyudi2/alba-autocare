                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('maintenance-types.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="biaya_standar" id="biaya_standar" value="{{ old('biaya_standar') }}" step="0.01"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="interval_km" id="interval_km" value="{{ old('interval_km') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="interval_bulan" id="interval_bulan" value="{{ old('interval_bulan') }}"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
