                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('vehicles.update', $vehicle) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nomor_polisi" id="nomor_polisi" value="{{ old('nomor_polisi', $vehicle->nomor_polisi) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="tahun" id="tahun" value="{{ old('tahun', $vehicle->tahun) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="warna" id="warna" value="{{ old('warna', $vehicle->warna) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="jenis" id="jenis"
                                ...
                                <option value="mobil" {{ old('jenis', $vehicle->jenis) == 'mobil' ? 'selected' : '' }}>Mobil</option>
                                <option value="motor" {{ old('jenis', $vehicle->jenis) == 'motor' ? 'selected' : '' }}>Motor</option>
                                <option value="truk" {{ old('jenis', $vehicle->jenis) == 'truk' ? 'selected' : '' }}>Truk</option>
                            </select>
                            @error('jenis')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
